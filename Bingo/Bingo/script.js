...
function desenharCartela(nomeJogador, cartela){
    ...
    var player = document.querySelector('nome-jogador')
    player.innerHTML = `<p class="jogador-inserido">${nomeJogador}</p>`;
    document.getElementById("nome-jogador").style = "width: 70%; height: 90vh; display: flex; flex-direction: column; justify-content: center;"
